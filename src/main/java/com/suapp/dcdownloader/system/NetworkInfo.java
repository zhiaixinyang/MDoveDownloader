...
/**
 * Created by zhaojing on 2018/4/11.
 */
...
public class NetworkInfo implements Parcelable {
     ...
     */
    private static final EnumMap<NetworkInfo.DetailedState, NetworkInfo.State> stateMap =
            new EnumMap<NetworkInfo.DetailedState, NetworkInfo.State>(NetworkInfo.DetailedState.class);

    static {
        stateMap.put(NetworkInfo.DetailedState.IDLE, NetworkInfo.State.DISCONNECTED);
        stateMap.put(NetworkInfo.DetailedState.SCANNING, NetworkInfo.State.DISCONNECTED);
        stateMap.put(NetworkInfo.DetailedState.CONNECTING, NetworkInfo.State.CONNECTING);
        stateMap.put(NetworkInfo.DetailedState.AUTHENTICATING, NetworkInfo.State.CONNECTING);
        stateMap.put(NetworkInfo.DetailedState.OBTAINING_IPADDR, NetworkInfo.State.CONNECTING);
        stateMap.put(NetworkInfo.DetailedState.VERIFYING_POOR_LINK, NetworkInfo.State.CONNECTING);
        stateMap.put(NetworkInfo.DetailedState.CAPTIVE_PORTAL_CHECK, NetworkInfo.State.CONNECTING);
        stateMap.put(NetworkInfo.DetailedState.CONNECTED, NetworkInfo.State.CONNECTED);
        stateMap.put(NetworkInfo.DetailedState.SUSPENDED, NetworkInfo.State.SUSPENDED);
        stateMap.put(NetworkInfo.DetailedState.DISCONNECTING, NetworkInfo.State.DISCONNECTING);
        stateMap.put(NetworkInfo.DetailedState.DISCONNECTED, NetworkInfo.State.DISCONNECTED);
        stateMap.put(NetworkInfo.DetailedState.FAILED, NetworkInfo.State.DISCONNECTED);
        stateMap.put(NetworkInfo.DetailedState.BLOCKED, NetworkInfo.State.DISCONNECTED);
    }
    ...
    public NetworkInfo(int type, int subtype, String typeName, String subtypeName) {
        ...
        setDetailedState(NetworkInfo.DetailedState.IDLE, null, null);
        mState = NetworkInfo.State.UNKNOWN;
    }
    ...
    public boolean isConnectedOrConnecting() {
        synchronized (this) {
            return mState == NetworkInfo.State.CONNECTED || mState == NetworkInfo.State.CONNECTING;
        }
    }
     ...
     * @param detailedState the {@link android.net.NetworkInfo.DetailedState}.
